...
func (w *maybeCompressResponseWriter) Hijack() (net.Conn, *bufio.ReadWriter, error) {
	...
	return nil, nil, errors.New("tea/middleware: http.Hijacker is unavailable on the writer")
}
...
func (w *maybeCompressResponseWriter) Close() error {
	...
	return errors.New("tea/middleware: io.WriteCloser is unavailable on the writer")
}
